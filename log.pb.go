...
func (*VolumeRequest) Descriptor() ([]byte, []int) { return fileDescriptorLog, []int{4} }
...
func init() {
	...
	proto.RegisterType((*VolumeRequest)(nil), "nomadatc.VolumeRequest")
}
...
func (this *VolumeRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&nomadatc.VolumeRequest{")
...
func (c *taskClient) RequestVolume(ctx context.Context, in *VolumeRequest, opts ...grpc.CallOption) (Task_RequestVolumeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Task_serviceDesc.Streams[2], c.cc, "/nomadatc.Task/RequestVolume", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptorLog = []byte{
	...
	,
}
